...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <div class="container" id="logo_change">
      <div class="row">
  ...
  <tbody>
    <tr>
      <th scope="row">1</th>
      <td>Abedinbazar logo</td>
      <td><img src="../dist/img/logo34.png" alt="" width="52" height="52"></td>
      <td><img src="../dist/img/logo34.png" alt="" width="52" height="52"></td>
      <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Add new</button>
    </tr>
      ...
      <div class="modal-body">
        <form>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Add logo:</label>
            <input type="file" class="form-control" id="recipient-name">
          </div>
          <div class="form-group">
            <label for="message-text" class="col-form-label">Add fivicon:</label>
            <input type="file" class="form-control" id="recipient-logo">
          </div>
        </form>
      </div>
