      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="./addProduct.php"><i class="fa fa-circle-o"></i> Add category</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="./allproduct.php"></i> All Product</a></li>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="post" action="">
              <div class="form-group">
                <label for="recipient-name" class="col-form-label">Add Cates</label>
                <input type="input" class="form-control" id="recipient-name" name="cates">
              </div>

              <div class="form-group">
                <label for="recipient-name" class="col-form-label">Add Sub Cates</label>
                <input type="input" class="form-control" id="recipient-name" name="sub-cates">
              </div>
              <div class="form-group">
                <label for="recipient-name" class="col-form-label">Add Sub-2 Cates</label>
                <input type="input" class="form-control" id="recipient-name"  name="sub-cates2">
              </div>
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary">Add Cates</button>
          </div>
        </div>
      </div>
    </div>
